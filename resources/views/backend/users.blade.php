                        ...
                        <td class="text-center align-middle">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><button class="dropdown-item" id="userView" value="{{ $row->id }}">VIew</button>
                                    </li>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="file" name="avatar" id="imgUser" class="form-control">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="buttons float-end">
                    <button type="button" class="btn btn-danger rounded-pill"><i class="fa-solid fa-circle-xmark"></i>
                        Disable</button>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-4">
                        ...
                        <img id="example" alt="Image insert Here" src="#" width="350">
                    </div>
    ...
    $(document).on('click', "#userView", function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                $("#example").attr('src', "{{ asset('') }}" + res.info.avatar);
